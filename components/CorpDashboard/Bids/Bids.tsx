			...
			{bidData.map((bid) => (
				<BidCard
					...
					panelDetails={{
						...
						customerName: bid.installationRequest.customer.firstName + " " + bid.installationRequest.customer.lastName,
						address: bid.installationRequest.address.province + "، " + bid.installationRequest.address.city + "، " + bid.installationRequest.address.streetAddress,
